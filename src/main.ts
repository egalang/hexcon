...
import CampaignRewardScene from "./scenes/CampaignRewardScene";
...
class BootScene extends Phaser.Scene {
  ...
  create() {
    GameData.initialize();
    console.log("GameData initialized", GameData.profile);
...
const config: Phaser.Types.Core.GameConfig = {
  ...
  scene: [BootScene, PreloaderScene, MenuScene, AiSetupScene, CampaignLevelSelectScene, OnlineLobbyScene, HexConquestScene, CampaignRewardScene],
};
